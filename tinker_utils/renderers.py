...
class UnparsedToolCall(pydantic.BaseModel):
    """
...
# Container for a part of a message content
ContentPart = TextPart | ThinkingPart | ToolCallPart | UnparsedToolCallPart
...
def get_renderer(
    ...
    # Import renderer classes lazily to avoid circular imports
    from tinker_utils.qwen import Qwen3Renderer, Qwen3DisableThinkingRenderer, Qwen3InstructRenderer
